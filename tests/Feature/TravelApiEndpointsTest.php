...
class TravelApiEndpointsTest extends TestCase
{
    ...
    public function canReadTravelList(): void
    {
        ...
        $db_count = Travel::whereIsPublic(true)->count();
    ...
    public function canCreateTravel(): void
    {
        ...
        $response = $this->post(route('travels.store'), $payload->toArray());
    ...
    public function canReadTravel(): void
    {
        ...
        $response = $this->get(route('travels.show', $payload));
    ...
    public function canUpdateTravel(): void
    {
        ...
        $response = $this->put(route('travels.update', $payload), $modified_payload->toArray());
    ...
    public function canDeleteTravel(): void
    {
        ...
        $response = $this->delete(route('travels.destroy', $payload));
